...
var _filter = require("./components/_filter");
var _tabs = require("./components/_tabs");

},{"./components/_burger":"aATkn","./components/_filter":"lPjby","./components/_tabs":"egXuX"}],"aATkn":[function(require,module,exports) {
...
},{}],"lPjby":[function(require,module,exports) {
...
if (tabs) {
    ...
    if (tabIdFromUrl) tabsButtons.forEach((button)=>{
        if (button.id === tabIdFromUrl) handleClick(button, tabIdFromUrl);
    });
}
...
function handleClick(ev, tabIdFromUrl) {
    ...
    if (tabIdFromUrl) {
        ...
        const tabPanel = tabsPanels.find((elem)=>{
            if (tabIdFromUrl === elem.getAttribute("aria-labelledby")) return true;
        });
        ...
        const tabPanel = tabsPanels.find((elem)=>{
            if (id === elem.getAttribute("aria-labelledby")) return true;
        });
        tabPanel.hidden = false;
    }
}

},{}]},["anvqh","gLLPy"], "gLLPy", "parcelRequire46ec")

//# sourceMappingURL=about.4d6bcbeb.js.map
